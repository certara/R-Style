...
certaraPNG <- function() {system.file("extdata", "logo", "Certara_CB.png", package="Certara.StyleR")}
styleCSS   <- function() {system.file("extdata", "css",  "certara.css",    package="Certara.StyleR")}
ICONDIR    <- function() {system.file("extdata", "icons",                  package="Certara.StyleR")}
